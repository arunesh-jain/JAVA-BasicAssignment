...
public class Main {
    public static void main(String[] args) {
        ...
        Employee emp1 = empFactory.getEmployee("Arunesh Jain", 23, "Delhi");
        Employee emp2 = empFactory.getEmployee("Rahul Yadav", 28, "Meerut");
//        Printer.print(emp1);
...
//        printTxt.accept(employees.toString());
